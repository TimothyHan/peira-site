...
export const sections: Record<Locale, SectionSet> = {
  en: {
    ...
    loop: {
      ...
      headClaim: "Five stages.",
      headQuiet: "One thinks. Four prove.",
    ...
    cta: {
      ...
      headClaim: "Write the plan.",
      headQuiet: "Compile the proof.",
