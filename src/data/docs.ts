...
peira compile intent --dry-run    # report only — nothing written`,
    codeLang: "bash",
    note: "--dry-run is the feedback loop on your document: how many sections compiled, and why any section was skipped (\"states no verifiable behavior; names no route or status code\") or a candidate refused. A skip is a note about your intent — usually prose, or a quality attribute no functional API case can state — not a failure of the tool.",
  },
  {
    num: "05",
